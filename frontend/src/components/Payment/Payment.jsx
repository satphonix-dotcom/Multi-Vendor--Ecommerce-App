...
const Payment = () => {
	...
	const [shippingOption, setShippingOption] = useState(
		localStorage.getItem("shippingOption") || "Standard - FREE"
	);
	const [packagingOption, setPackagingOption] = useState(
		localStorage.getItem("packagingOption") || "Standard"
	);
	useEffect(() => {
	...
	useEffect(() => {
		localStorage.setItem("packagingOption", packagingOption);
	}, [packagingOption]);
	...
	const handleChangePackaging = (event) => {
		setPackagingOption(event.target.value);
	};
